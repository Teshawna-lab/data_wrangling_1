...
\#\#filter: intended to keep rows in which you are interested in keeping
for subsequent analysis; sekect operates on columns, filter operates on
rows
...
You can ask if gd\_of\_birth ==20, you use more than one equal sign
because you are not trying to say that the variable is = the number 20.
It is a test for equality
